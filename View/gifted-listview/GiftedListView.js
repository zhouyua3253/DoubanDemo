...
const GiftedListView = React.createClass({
    ...
    emptyView(refreshCallback) {
        ...
        return (
            <View style={[this.defaultStyles.defaultView, this.props.customStyles.defaultView, {height: this.height}]}>
    ...
    _onScroll(event) {
        ...
        // 距底部小于100时开始加载下一页
        if(this.props.pagination && distance < 60 && !this.isLoadingMore && this.state.paginationStatus !== 'allLoaded' && this._getRows().length > 0) {
